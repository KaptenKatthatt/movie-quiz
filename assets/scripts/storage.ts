...
export class Storage {
  ...
  setPlayerNameToLocalStorage = (playerName: string) => {
  ...
  getHighScoreListFromLocalStorage = function () {
    return localStorage.getItem("highScoreList");
  };

  setHighScoreListToLocalStorage = function (highScoreList: Player[]): void {
