...
exports.game = exports.ui = void 0;
...
exports.game = {
    ...
    restart() {
        ...
        if (exports.ui.highScoreListEl) {
            exports.ui.highScoreListEl.innerHTML = "";
        }
    ...
    player: {
        ...
        nbrOfQuestions: 0,
        get score() {
            return exports.game.nbrOfRightAnswers;
        },
        name: (0, storage_js_1.getPlayerNameFromLocalStorage)() || "someNonameDude",
    },
